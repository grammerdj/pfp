...
-- ---------------------------- --
# Script for Creating Participant Current Financial Table Update Logging Trigger
-- ---------------------------- --
...
DROP TRIGGER IF EXISTS `trg_part_curr_fin_upd`;
DELIMITER //
CREATE TRIGGER `trg_part_curr_fin_upd`
AFTER UPDATE ON `t_part_curr_fin`
FOR EACH ROW
BEGIN
