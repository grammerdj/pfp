...
-- ---------------------------- --
# Script for Creating Participant Configured Allocations Logging Table
-- ---------------------------- --
...
CREATE TABLE IF NOT EXISTS `t_part_allocations_hist` (
  ...
  `snapshot_ts` DATETIME NOT NULL COMMENT "Original Record Insert Timestamp",
